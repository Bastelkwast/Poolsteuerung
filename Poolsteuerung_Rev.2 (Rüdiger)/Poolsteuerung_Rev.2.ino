...
char firmwareversion[] = "Rev.2 Ruediger";

//Variablen für die Temperatursensoren
#define TEMPERATURE_PRECISION 9

// Addressen der 3 DS18B20
uint8_t sensor1[8] = { 0x28, 0xFF, 0x2, 0xB4, 0x80, 0x14, 0x2, 0x5D };
uint8_t sensor2[8] = { 0x28, 0xFF, 0xEE, 0x19, 0x80, 0x14, 0x2, 0x92 };
uint8_t sensor3[8] = { 0x28, 0xFF, 0x39, 0x1B, 0x80, 0x14, 0x2, 0x9A };
...
void setRelais() {
  ...
  if (temp2 - temp1 >= TempDivEin && Betrieb && !sensor_fail && !poolMaxtemp) {
    digitalWrite (relais1, LOW);
    relaisstat1 = 1;
    //Serial.println("Relais1 = Ein:");
    //Serial.println();
  }
  else if (temp2 - temp1 <= TempDivAus || Betrieb == 0 || sensor_fail || poolMaxtemp ) {
