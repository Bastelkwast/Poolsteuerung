...
uint8_t sensor0[8] = { 0x28, 0xF, 0x51, 0x94, 0x97, 0x8, 0x3, 0x4C }; //Panel
...
void Tempcheck() {
  ...
  temp0 = sensors.getTempC(sensor0);
  if (temp0 <= -100) {
    sensor_fail0 = true;
  }
  else {
 ...
 temp1 = sensors.getTempC(sensor1);
  ...
  if (sensor_fail0 || sensor_fail1 || sensor_fail2 || sensor_fail3) {
    sensor_fail = true;
  }
  else
  {
